...
export const projects: Project[] = [
    ...
    image:
      "/turtlebot3.jpg",
    topics: ["C++", "ROS2", "SLAM", "Sensor Fusion", "Localization"],
    links: [
  ...
  },
  {
    ...
    image:
      "/MQP-self-test.jpg",
    topics: ["C++", "PlatformIO", "ESP32", "MPRLS", "H-bridge", "Custom PCB", "TFT Display"],
    links: [
      { label: "GitHub", url: "https://github.com/" },
      { label: "Live Demo", url: "https://example.com/" },
    ],
  },
  {
    ...
    details:
      "The 4-DOF Robotic Arm project focused on the modeling, control, and task-space manipulation of a robotic manipulator using a combination of analytical kinematics, simulation tools, and vision-based object detection. The system was developed using MATLAB and Simulink to model the robot’s kinematic structure, plan motion trajectories, and test control algorithms before physical implementation.\n\nThe arm’s geometry was defined using Denavit–Hartenberg parameters, enabling the derivation of forward kinematics to determine the end-effector position from joint angles and inverse kinematics to compute the joint configurations required to reach a target position within the robot’s workspace. These models were used to analyze the arm’s task space, ensuring that objects detected by the system were reachable and could be manipulated accurately.\n\nTrajectory planning algorithms were implemented to generate smooth joint-space motion between positions while maintaining stability and avoiding abrupt movements. The planned trajectories were simulated and visualized in MATLAB using a 3D stick model of the manipulator to verify the robot’s motion and end-effector path before execution.\n\nA camera-based vision system was integrated to detect and classify objects by color. Image processing techniques were used to filter the camera feed and isolate objects using color thresholds, allowing the robot to determine object locations within the workspace. These detections were converted into task-space coordinates, which were then used by the inverse kinematics algorithms to position the end effector for object interaction.\n\nThis project combined robot kinematics, trajectory planning, computer vision, and simulation-based validation to create a robotic system capable of detecting colored objects and performing controlled manipulations within its workspace.",
    thumbnail:
      "/4DOF.jpg",
    image:
      "/4DOF.jpg",
    topics: ["MATLAB", "Simulink", "C/C++", "Forward Kinematics", "Inverse Kinematics", "Computer Vision"],
    links: [
      { label: "GitHub", url: "https://github.com/" },
  ...
  },
  {
    ...
    details:
      "The Autonomous Maze Navigation Robot project developed a maze-solving system using a Pololu Romi 32U4 platform with an ESP32 for wireless communication. IMU and encoders provided odometry and orientation, while AprilTags were used for localization. Robots shared navigation status and obstacle data via MQTT to coordinate movements through the maze.\n\nThe control strategy prioritized consistent heading and collision avoidance using sensor fusion of IR distance sensors and camera-based tag detection. A path planner chose route segments in real-time, and a state machine handled transitions between exploration, obstacle reaction, and goal-seeking behaviors.\n\nA key deliverable was reliable multi-robot cooperation: robots updated each other’s internal map and traversal decisions, enabling dynamic rerouting based on newly detected barriers. The project demonstrated robust autonomous navigation in constrained environments with real-world sensor noise and communication latency.",
    thumbnail:
      "/RBE2002.jpg",
    image:
      "/RBE2002.jpg",
    topics: ["C/C++", "Pololu Romi 32U4", "ESP32", "MQTT", "AprilTags", "Sensor Fusion"],
    links: [
      { label: "GitHub", url: "https://github.com/" },
      { label: "Live Demo", url: "https://example.com/" },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "A collection of web development projects showcasing skills in frontend and backend technologies, UI/UX design, and performance optimization.",
    details:
      "Built a full-stack web application with a 3-person team that connects students with faculty research opportunities on campus. Students can browse open positions, submit applications, and manage their profiles, while faculty can post positions and review or manage incoming applications. The platform features role-based authentication — separate login flows for students and faculty — along with dynamic forms, relational database design, and a clean responsive interface built for ease of use.",
    thumbnail:
